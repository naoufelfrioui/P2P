...
import no.bouvet.p2pcommunication.util.button.MapButton;
...
public class DiscoveryAndConnectionFragment extends ListFragment implements DiscoveryStateListener, PeerListListener, InvitationToConnectListener, ConnectionInfoListener {
    ...
    //@InjectView(R.id.right_bottom_button2) MapButton rightBottomButton2;
    ...
    private static Bundle getFragmentArguments() {
        ...
        fragmentArguments.putString(P2pCommunicationFragmentPagerAdapter.FRAGMENT_TITLE, "VERFÜGBARE GERÄTE");
