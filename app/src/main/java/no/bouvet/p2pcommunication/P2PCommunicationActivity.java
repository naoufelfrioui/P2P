...
public class P2PCommunicationActivity extends FragmentActivity
        implements WifiP2pListener, MulticastListener   ,View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // bPosition = (Button)findViewById(R.id.bmaps);
    ...
    public void onClick(View view) {
      ...
      //          Intent intentMain = new Intent(this , MapsActivity.class);
       //       this.startActivity(intentMain);
        //        registerLink.setText("naoufel frioui");
